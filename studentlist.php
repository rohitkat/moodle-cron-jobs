...
<head>
    <title>Re-enrolled student</title>
    ...
    <div class="container mt-3">
     ...
     <!--        <form name="form1" id="renrolleddata" style="width: 100%;">
      ...
      <tr>
        ...
        <td><button class='btn-success'  onclick='myfunction2("<?=$value["email"]?>")'>reenrolled</button></td>
      </tr>
      <?php } ?>
    </tbody>
        </table>
...
<script type="text/javascript">
    ...
    $("#renrolleddata").submit(function(e) {
        ...
        data.append("add_type", 'search_student_reenroll');
        e.preventDefault();
    ...
    function renderresult(arr) {
        ...
        arr.forEach(function(entry, value) {
            var action = "<button class='btn-success' onclick='myfunction2(" + JSON.stringify(entry['email']) + ")'>re-enrolled</button>";
...
function myfunction2(email)
{
        ...
        data.append("type", 'student_reenroll');
         $("body").addClass("loading"); 
        var xmlhttp = new XMLHttpRequest();
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
